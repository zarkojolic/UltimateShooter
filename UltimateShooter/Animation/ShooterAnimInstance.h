...
protected:
	...
	//! Handle Calculation for the leaning while running
...
private:
	...
	//! Yaw of the Character previous frame; only updated when standing still and not in the air
	...
	//! Changed the recoil weight based on turning in place and aiming
	...
	//! Weapon Type of the currently equiped weapon
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "Combat", meta = (AllowPrivateAccess = "true"))
